...
export default function PodCastModal(props: any) {
    ...
    return (
        <div className='bg-white pb-20' style={{width: '900px'}} >
            ...
            <div style={{backgroundColor: '#28166F'}} className=' w-full flex items-center  px-12 h-28' >
                <p className='text-xl text-white font-Poppins-Medium ' >Add PodCast</p>
            ...
            <div style={{width: '480px'}} className='mx-auto my-8' >
                ...
                <p className=' font-Poppins-Regular text-sm mb-2 mt-4' >PodCast Link</p>
                <Input 
                    name="name"
                    onChange={formik.handleChange}
                    onFocus={() =>
