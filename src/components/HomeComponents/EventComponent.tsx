    ...
    return(
        <div className='w-full pb-10' >
            ...
            <div className='mt-6 w-full grid grid-cols-4 gap-6' >
                <div style={{backgroundColor: '#F4F4F4'}} className='w-full relative' >
                    <img src={Image} alt='ima@' className='object-cover w-full h-56' />
                    ...
                    <div className='my-4 px-4 w-full' >
                        <p style={{color: '#28166F'}} className='font-Poppins-Bold' >Glory of God Programme</p>
                        <p style={{color: '#3E4E5C'}} className='font-Poppins-Regular text-xs mt-1' >Glory of God Programme</p>
                        <div className='flex items-center mt-4 ' >
                            <div className='flex items-center' >
                                ...
                                <p style={{color: '#3E4E5C'}} className='ml-2 font-Poppins-Regular text-xs mt-1' >12, Jun 2021</p>
                            </div>
                            <div className='flex items-center ml-8' >
                                ...
                                <p style={{color: '#3E4E5C'}} className='ml-2 font-Poppins-Regular text-xs mt-1' >9am</p>
                            </div>
                        </div>
                    </div>
                </div>
