    ...
    return(
        <div className='w-full pb-10' >
            <div className='w-full flex items-center' >
                ...
                <button onClick={()=> setShowModal(true)} style={{border:'1px solid #28166F'}} className='w-36 text-active text-sm py-3 ml-auto font-Poppins-Regular justify-center rounded-md flex items-center' >
                ...
                (
                    <>
                        <div className="h-auto flex justify-center items-center overflow-x-hidden overflow-y-hidden fixed pb-4 px-4 inset-0 z-50 outline-none focus:outline-none"> 
                            <AnnouncementModal close={setShowModal} />
                        </div> 
